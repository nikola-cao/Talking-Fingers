...
enum TFColors {
    ...
    // Navigation
    static let tabBlue = Color(red: 0.30, green: 0.55, blue: 0.85)
    ...
    // Practice / statistics accents
    static let amber = Color(hex: 0xECA509)
    static let deepGreen = Color(hex: 0x71A046)
    static let red = Color(hex: 0xF46769)
    static let paleRed = Color(hex: 0xFFE0E1)
    static let textGray = Color(hex: 0x767676)
    static let lightGray = Color(hex: 0xB3B3B3)
    static let borderLight = Color(hex: 0xF0F0F0)
    static let borderGray = Color(hex: 0xE8E8E8)
    static let placeholderGray = Color(hex: 0xF5F5F5)
    static let headerBlue = Color(hex: 0x2A7BBC)
    static let headerGradientTop = Color(hex: 0xEEF6FB)
